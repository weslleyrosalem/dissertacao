...
plt.plot(test.index[SEQ_LENGTH:], scaler.inverse_transform(y_test), label="Actual Test")
plt.plot(test.index[SEQ_LENGTH:], scaler.inverse_transform(y_pred_rescaled), label="Predicted Test")
plt.legend()
plt.show()
